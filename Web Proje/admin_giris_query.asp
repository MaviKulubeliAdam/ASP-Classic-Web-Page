<%
    ...
    if not rs.EOF  then 
        ...
        <meta http-equiv="refresh" content="4; URL=./admin_anasayfa.asp" />
    <%
    else
        response.Write "<h4> Kullanıcı Adı veya Şifre Hatalı </h4>" %>
        <meta http-equiv="refresh" content="4; URL=./admin_giris.asp" />
        <%
    end if
